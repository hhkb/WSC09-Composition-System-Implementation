	...
	private static void calculateCommonOutputs(PlanningGraph leanSolutionPG){
		...
		do{
			if(currentLevel == leanSolutionPG.getALevels().size() - 1){
				...
				Set<Service> allServices = leanSolutionPG.getAllServices();
...
//			if(s.equals("serv91250331")){
//				System.out.println("common outputs:");
//				for(Concept c : s.getCommonOutputs()){
//					System.out.println("++++ " + c);
//				}
//			}
			for(Service b : s.getBackupServiceSet()){
				System.out.println(b);
//				if(b.equals("serv783934155")){
//					System.out.println("outputs:");
//					for(Concept c : b.getOutputConceptSet()){
//						System.out.println("---- " + c);
//					}
//				}
			}
...
//				if(candidate.getOutputConceptSet().containsAll(s.getCommonOutputs())){
//					s.getBackupServiceSet().add(candidate);
////					System.out.println("candidate: " + candidate + " added for: " + s);
//				}
//			}
//			System.out.println("*******");
//			System.out.println("service " + s + "'s backups:");
...
//		Set<PlanningGraph> leanSolutions = new HashSet<PlanningGraph>();
		...
		removedServices.add(serviceMap.get("serv157405514"));
		removedServices.add(serviceMap.get("serv1612205357"));//break solution 1
