...
public class UsageObjective
   ...
   *          the steps required
   */
  public UsageObjective(final int requiredSteps) {
  ...
  public void endEvaluation(
    ...
    if (n.m_cs_used) {
      ...
      for (i = (c - 1); i >= 0; i--) {
        x = ((ICSVM) (n.getVirtualMachine(i))).getCSTimes();
        if (x < min)
          min = x;
        s += x;
      }
      ...
      if (s > 0) {
        state.setObjectiveValue((1d / s) - (min + 1));
      }
    }
  }
