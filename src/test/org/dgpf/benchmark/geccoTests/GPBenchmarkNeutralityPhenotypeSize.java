 ...
 * @author Locu
 */
public class GPBenchmarkNeutralityPhenotypeSize extends
   ...
   * the titles
   */
  private static final String[] TITLES = new String[] { "neutrality", //$NON-NLS-1$
   ...
   */
  private static final NumericIterator NEUTRALITY = new NumericIterator(1,
      1, 1, true, PHENOTYPE_SIZE);

  /**
   * the iterator for the population sizes to test
   */
  private static final Iterator<Object[]> ITERATOR = new MultiCascadingIterator(
      new IStepable[] { NEUTRALITY, PHENOTYPE_SIZE });
   ...
   *          the directory
   */
  public GPBenchmarkNeutralityPhenotypeSize(final Object dir) {
  ...
  public static void main(final String[] args) {
    GPBenchmarkNeutralityPhenotypeSize x;

    // x = new PopulationSizeRuggedness(".\\neutralityPhenoLen");
    // //$NON-NLS-1$
    x = new GPBenchmarkNeutralityPhenotypeSize(
        "d:\\temp\\newModel\\neutralityPhenoLen"); //$NON-NLS-1$
