 ...
 * @author Locu
 */
public class GPBenchmarkEpistasisPhenotypeSize extends
  ...
  private static final NumericIterator PHENOTYPE_SIZE = new NumericIterator(
      8, 8, 8, true, (CascadedIterator<?>) null);

  /**
   * the epistasis iterator
   */
  private static final NumericIterator EPISTASIS = new NumericIterator(8,
      8, 5, true, PHENOTYPE_SIZE);
   ...
   *          the directory
   */
  public GPBenchmarkEpistasisPhenotypeSize(final Object dir) {
  ...
  public static void main(final String[] args) {
    GPBenchmarkEpistasisPhenotypeSize x;

    x = new GPBenchmarkEpistasisPhenotypeSize(
        "d:\\temp\\newModel\\epistasisPhenoLen"); //$NON-NLS-1$
