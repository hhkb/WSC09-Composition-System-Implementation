 ...
 * @author Thomas Weise
 */
public class NeutralitySettings extends GPBenchmarkTestSeries {
  /**
   ...
   *          the directory
   */
  public NeutralitySettings(final Object dir) {
  ...
  public static void main(final String[] args) {
    NeutralitySettings x;

    x = new NeutralitySettings("neutrality-all"); //$NON-NLS-1$
