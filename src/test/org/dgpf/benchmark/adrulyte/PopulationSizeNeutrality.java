 ...
 */
public class PopulationSizeNeutrality extends GPBenchmarkTestSeries {
  /**
   ...
   */
  private static final NumericIterator NEUTRALITY = //
  ...
  private static final Iterator<Object[]> ITERATOR = new MultiCascadingIterator(
      new IStepable[] { NEUTRALITY, POPULATION_SIZE });
   ...
   *          the directory
   */
  public PopulationSizeNeutrality(final Object dir) {
  ...
  protected void setupParameters(final Object[] parameters) {
    ...
    this.getTunableModel().setNeutralityDifficultyLevel(
  ...
  public static void main(final String[] args) {
    PopulationSizeNeutrality x;

    x = new PopulationSizeNeutrality("e:\\temp\\ps-rug"); //$NON-NLS-1$
