 ...
 */
public class PopulationSizeEpistasis extends GPBenchmarkTestSeries {
  /**
   ...
   */
  private static final NumericIterator EPISTASIS = //
  ...
  private static final Iterator<Object[]> ITERATOR = new MultiCascadingIterator(
      new IStepable[] { EPISTASIS, POPULATION_SIZE });
   ...
   *          the directory
   */
  public PopulationSizeEpistasis(final Object dir) {
  ...
  public static void main(final String[] args) {
    PopulationSizeEpistasis x;

    x = new PopulationSizeEpistasis("e:\\temp\\ps-rug"); //$NON-NLS-1$
