 ...
 * @author Ich
 */
public class NoisePhenotypeSize80Test extends GPBenchmarkTestSeries {
  /**
   ...
   */
  private static final NumericIterator NOISE = new NumericIterator(0, 40,
      1, true, (CascadedIterator<?>) null);
  ...
  private static final Iterator<Object[]> ITERATOR = new MultiCascadingIterator(
      new IStepable[] { TEST_CASE_COUNT, NOISE });
   ...
   *          the directory
   */
  public NoisePhenotypeSize80Test(final Object dir) {
  ...
  protected void setupParameters(final Object[] parameters) {
    ...
    this.getTunableModel().setInternalNoiseDifficultyLevel(
  ...
  public static void main(final String[] args) {
    NoisePhenotypeSize80Test x;

    x = new NoisePhenotypeSize80Test("noisePhenotypeSize80"); //$NON-NLS-1$
