 ...
 * @author Ich
 */
public class RuggednessPhenotypeSizeTest extends GPBenchmarkTestSeries {
  /**
   ...
   *          the directory
   */
  public RuggednessPhenotypeSizeTest(final Object dir) {
  ...
  public static void main(final String[] args) {
    RuggednessPhenotypeSizeTest x;

    x = new RuggednessPhenotypeSizeTest("ruggednessPhenoLen"); //$NON-NLS-1$
