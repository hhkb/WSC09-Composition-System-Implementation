 ...
 * Original Filename: test.org.dgpf.election.lgp.LGPElectionProvider.java
 ...
 * @author Thomas Weise
 */
public class LGPElectionProvider extends NetworkProvider<LGPMemory> {
  /**
  ...
  public LGPElectionProvider(final LGPNetParameters parameters,
      final boolean randomizeScenarios, final int scenarioCount) {
    super(LGPElectionNetwork.class, parameters, randomizeScenarios,
        scenarioCount);
  }
  ...
  public ISimulation<?> createSimulation() {
    return new LGPElectionNetwork(this);
  }
