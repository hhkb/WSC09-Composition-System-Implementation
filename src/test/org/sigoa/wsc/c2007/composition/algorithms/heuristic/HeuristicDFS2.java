 ...
 * Original Filename: test.org.sigoa.wsc.c2007.composition.algorithms.heuristic.HeuristicDFS2.java
 ...
 * @author Thomas Weise
 */
public class HeuristicDFS2 implements ICompositionAlgorithm {

  /**
   * The globally shared factory
   */
  public static final ICompositionAlgorithmFactory HEURISTIC_DFS_FACTORY2 = new ICompositionAlgorithmFactory() {
    public ICompositionAlgorithm createCompositionAlgorithm() {
      return new HeuristicDFS2();
    }
  };
  ...
  public final void compose(final Challenge c) {
    ...
    cc = this.compose(c.getIn(), c.getOut(), c);
    if ((cc == null) || (c.solved()))
      return;
   ...
   */
  public final Composition compose(final ConceptList known,
    ...
    main: for (;;) {
      ...
      if (cl.m_count <= 0)
        break;
      Arrays.sort(cl.m_data, 0, cl.m_count, Heuristic1.H1);
      for (;;) {
  ...
  //
  // Below you can find a version of the same algorithm that guarantees
  // to find the shortest possible configuration. This however turns
  // quickly unfeasible. This method is now included in HeuristicDFS3
  //
  // /**
  // * Find a composition suitable to solve the given task.
  // *
