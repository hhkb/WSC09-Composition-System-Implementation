 ...
 * @author Thomas Weise
 */
final class ConceptList extends SimpleList<Concept> {

  /**
   * the array constructor
   */
  private static final IArrayConstructor<Concept> CONSTR = new IArrayConstructor<Concept>() {
    /**
   ...
   */
  ConceptList(final ConceptList copy) {
    super(copy);
  }
