 ...
 * Original Filename: test.org.sigoa.dmc.ABObjectiveFunction.java
...
/**
 * The BA-misclassification objective function.
 *
 * @author Thomas Weise
 */
public class BAObjectiveFunction
    extends
  ...
  /**
   * Create a BA-misclassification objective function.
   */
  public BAObjectiveFunction() {
    super();
  }
  ...
  public void endEvaluation(final ClassifierSystem individual,
    ...
    state.setObjectiveValue(ClassificationObjectiveFunction.modify(
        simulation.getClassification(EClasses.B, EClasses.A), individual
            .getSize()));
  }
