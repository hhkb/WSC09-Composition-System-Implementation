...
/**
 * The ab-misclassification objective function.
 *
 * @author Thomas Weise
 */
public class ABObjectiveFunction
    extends
  ...
  /**
   * Create a ab-misclassification objective function.
   */
  public ABObjectiveFunction() {
    super();
  }
  ...
  public void endEvaluation(final ClassifierSystem individual,
    ...
    state.setObjectiveValue(ClassificationObjectiveFunction.modify(
        simulation.getClassification(EClasses.A, EClasses.B), individual
            .getSize()));
  }
