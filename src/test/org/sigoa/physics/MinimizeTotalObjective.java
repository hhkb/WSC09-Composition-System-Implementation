 ...
 * @author Thomas Weise
 */
public class MinimizeTotalObjective extends
  ...
  PhysicsContext> MAXIMIZE_CORRECT_OBJECTIVE = new MinimizeTotalObjective();

  /**
   * Create the objective function
   */
  protected MinimizeTotalObjective() {
    super();
  }
  ...
  private final Object readResolve() {
    if (this.getClass() == MinimizeTotalObjective.class)
...
//    state.setObjectiveValue(simulation.m_total);
  }
}
