 ...
 * @author Thomas Weise
 */
public class MinimizeDeviationObjective extends
  ...
  PhysicsContext> MAXIMIZE_CORRECT_OBJECTIVE = new MinimizeDeviationObjective();

  /**
   * Create the objective function
   */
  protected MinimizeDeviationObjective() {
    super();
  }
  ...
  private final Object readResolve() {
    if (this.getClass() == MinimizeDeviationObjective.class)
  ...
  public void toStringBuilder(final StringBuilder sb) {
    sb.append("correctness"); //$NON-NLS-1$
  }
...
//    state.setObjectiveValue(simulation.m_res);
  }
}
