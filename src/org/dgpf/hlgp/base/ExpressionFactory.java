 ...
 * Original Filename: org.dgpf.hlgp.base.ExpressionFactory.java
...
/**
 * This factory creates high-level expressions
 *
 * @author Thomas Weise
 */
public abstract class ExpressionFactory extends ConstructFactory {
  /**
   ...
   */
  protected ExpressionFactory(final Class<? extends Node> clazz,
