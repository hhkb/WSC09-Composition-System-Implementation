 ...
 * @author Thomas Weise
 */
public class StoreFactory extends InstructionFactory {
  /** the serial version uid */
  private static final long serialVersionUID = 1;

  /**
   * The globally shared factory for the store instruction.
   */
  public static final INodeFactory STORE_FACTORY = new StoreFactory(
      Store.class);
   ...
   *          the class
   */
  protected StoreFactory(final Class<? extends Store> clazz) {
    super(clazz, 1, 1);
  }
  ...
  public Node create(final Node[] children, final IRandomizer random) {
    return new Store(random.nextInt(), children);
  }
}
