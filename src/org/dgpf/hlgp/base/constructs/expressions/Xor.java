 ...
 * Original Filename: org.dgpf.machine.hl.constructs.expressions.Xor.java
...
/**
 * This instruction is a xor expression
 * 
 * @author Thomas Weise
 */
public class Xor extends ArithExpression {
  /**
   ...
   *          the operands
   */
  public Xor(final Node[] operands) {
    super(operands);
  }
  ...
  public INodeFactory getFactory() {
    return ArithExpressionFactories.XOR_FACTORY;
  }
