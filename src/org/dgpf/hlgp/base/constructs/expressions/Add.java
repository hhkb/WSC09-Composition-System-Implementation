 ...
 * Original Filename: org.dgpf.machine.hl.constructs.expressions.Add.java
...
/**
 * This instruction is an add expression
 * 
 * @author Thomas Weise
 */
public class Add extends ArithExpression {
  /**
   ...
   *          the operands
   */
  public Add(final Node[] operands) {
    super(operands);
  }
  ...
  public INodeFactory getFactory() {
    return ArithExpressionFactories.ADD_FACTORY;
  }
