 ...
 * Original Filename: org.dgpf.machine.hl.constructs.expressions.Mod.java
...
/**
 * This instruction is a mod expression
 * 
 * @author Thomas Weise
 */
public class Mod extends ArithExpression {
  /**
   ...
   *          the operands
   */
  public Mod(final Node[] operands) {
    super(operands);
  }
  ...
  public INodeFactory getFactory() {
    return ArithExpressionFactories.MOD_FACTORY;
  }
