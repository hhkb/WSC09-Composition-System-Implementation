 ...
 * Original Filename: org.dgpf.machine.hl.constructs.expressions.Sub.java
...
/**
 * This instruction is a sub expression
 * 
 * @author Thomas Weise
 */
public class Sub extends ArithExpression {
  /**
   ...
   *          the operands
   */
  public Sub(final Node[] operands) {
    super(operands);
  }
  ...
  public INodeFactory getFactory() {
    return ArithExpressionFactories.SUB_FACTORY;
  }
