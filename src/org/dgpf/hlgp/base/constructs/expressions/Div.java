 ...
 * Original Filename: org.dgpf.machine.hl.constructs.expressions.Div.java
...
/**
 * This instruction is a div expression
 * 
 * @author Thomas Weise
 */
public class Div extends ArithExpression {
  /**
   ...
   *          the operands
   */
  public Div(final Node[] operands) {
    super(operands);
  }
  ...
  protected void toStringBuilder(final StringBuilder sb, final int indent) {
    if (this.size() >= 2) {
      ...
      sb.append(TEXT);
      nodeToStringBuilder(this.get(1), sb, 0);
      sb.append(')');
    } else
      sb.append('0');
  }
  ...
  public INodeFactory getFactory() {
    return ArithExpressionFactories.DIV_FACTORY;
  }
