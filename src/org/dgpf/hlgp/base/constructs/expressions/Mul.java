 ...
 * Original Filename: org.dgpf.machine.hl.constructs.expressions.Mul.java
...
/**
 * This instruction is a mul expression
 * 
 * @author Thomas Weise
 */
public class Mul extends ArithExpression {
  /**
   ...
   *          the operands
   */
  public Mul(final Node[] operands) {
    super(operands);
  }
  ...
  public INodeFactory getFactory() {
    return ArithExpressionFactories.MUL_FACTORY;
  }
