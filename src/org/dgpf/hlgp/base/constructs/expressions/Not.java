 ...
 * Original Filename: org.dgpf.machine.hl.constructs.expressions.Not.java
...
/**
 * This instruction is an not expression
 * 
 * @author Thomas Weise
 */
public class Not extends Expression {
   ...
   *          the operands
   */
  public Not(final Node[] operands) {
    super(operands);
  }
  ...
  public void compile(final HLGPCompiler compiler) {
    ...
    if (this.size() >= 1) {
      ...
      if (n instanceof Expression) {
        s = ((Expression) n).provideResultVariable(compiler);
      } else
        s = null;
