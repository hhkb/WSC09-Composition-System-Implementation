 ...
 * Original Filename: org.dgpf.rbgp.net.actions.ResetAction.java
...
package org.dgpf.rbgp.net.actions;
...
public class SendAction extends Action<RBGPNetVM> {
   ...
   *          The action set
   */
  public SendAction(final ActionSet actionSet) {
    super(actionSet);
  }
  ...
  public EVirtualMachineState perform(final Symbol sym1,
      final Symbol sym2, final RBGPNetVM vm) {
    vm.send();
