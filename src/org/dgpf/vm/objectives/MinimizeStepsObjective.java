 ...
 * Original Filename: org.dgpf.vm.objectives.MinimizeStepsObjective.java
 ...
 * @author Thomas Weise
 */
public class MinimizeStepsObjective
    extends
  ...
  ISimulation<VirtualMachineProgram<Serializable>>> MINIMIZE_STEPS_OBJECTIVE = new MinimizeStepsObjective();

  /**
   * Create the objective function
   */
  protected MinimizeStepsObjective() {
    super();
  }
  ...
  private final Object readResolve() {
    if (this.getClass() == MinimizeStepsObjective.class)
      return MINIMIZE_STEPS_OBJECTIVE;
    return this;
  }
  ...
  public void endEvaluation(
    ...
    state.setObjectiveValue(//
        ((IVirtualMachineSimulationInformation) simulation)
            .getPerformedSteps());
  }
}
