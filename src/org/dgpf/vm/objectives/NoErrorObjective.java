...
public class NoErrorObjective
  ...
  ISimulation<VirtualMachineProgram<Serializable>>> NO_ERROR_OBJECTIVE = new NoErrorObjective();

  /**
   * Create the objective function
   */
  protected NoErrorObjective() {
    super();
  }
  ...
  private final Object readResolve() {
    if (this.getClass() == NoErrorObjective.class)
      return NO_ERROR_OBJECTIVE;
    return this;
  }
  ...
  public void endEvaluation(
    ...
    state.setObjectiveValue(//
        (((IVirtualMachineSimulationInformation) simulation)
            .getVirtualMachineState() == EVirtualMachineState.ERROR) ? 1
            : 0);
  }
}
