 ...
 * Original Filename: org.dgpf.vm.net.objectives.MinimizeTransmissionsObjective.java
 ...
 * @author Thomas Weise
 */
public class MinimizeTransmissionsObjective
    extends
  ...
  ISimulation<VirtualMachineProgram<Serializable>>> MINIMIZE_TRANSMISSIONS_OBJECTIVE = new MinimizeTransmissionsObjective();

  /**
   * Create the objective function
   */
  protected MinimizeTransmissionsObjective() {
    super();
  }
  ...
  private final Object readResolve() {
    if (this.getClass() == MinimizeTransmissionsObjective.class)
      return MINIMIZE_TRANSMISSIONS_OBJECTIVE;
    return this;
  }
  ...
  public void toStringBuilder(final StringBuilder sb) {
    sb.append("transmissions"); //$NON-NLS-1$
  }
  ...
  public void endEvaluation(
    ...
    s = ((INetVirtualMachineSimulationInformation) simulation)
        .getMessageCount();
    if (s > 0)
