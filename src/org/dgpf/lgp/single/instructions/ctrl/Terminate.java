 ...
 * Original Filename: org.dgpf.lgp.single.instructions.ctrl.Call.java
...
package org.dgpf.lgp.single.instructions.ctrl;
 ...
 * @author Thomas Weise
 */
public class Terminate extends
    org.dgpf.lgp.base.instructions.ctrl.Terminate<LGPVM<?>> {
  /** serial version uid */
   ...
   */
  public Terminate(final InstructionSet isb) {
    super(isb);
  }
   ...
   */
  @Override
  public void execute(final LGPVM<?> vm, final int param1,
