 ...
 * Original Filename: org.dgpf.machine.ll.instructions.arith.Mul.java
...
/**
 * This instruction multiplies two numbers.
 * 
 * @author Thomas Weise
 */
public class Mul extends ArithInstruction {
   ...
   */
  public Mul(final InstructionSet isb) {
    super(isb);
  }
  ...
  protected boolean isUseless(final EIndirection indir1, final int index1,
    ...
    return (super
        ...
        ((indir3 == indir1) && (index3 == index1)
            && (indir2 == EIndirection.CONSTANT) && (index2 == 1)) || ((indir2 == indir1)
        && (index2 == index1) && (indir3 == EIndirection.CONSTANT) && (index3 == 1)));
  }
