 ...
 * Original Filename: org.dgpf.machine.ll.instructions.arith.And.java
...
/**
 * This instruction ands two numbers.
 * 
 * @author Thomas Weise
 */
public class And extends ArithInstruction {
   ...
   * the operation text
   */
  static final char[] OP_TXT = " and ".toCharArray(); //$NON-NLS-1$
   ...
   */
  public And(final InstructionSet isb) {
    super(isb);
  }
  ...
  protected boolean isUseless(final EIndirection indir1, final int index1,
    ...
    return (super
        ...
        || //
        ((indir3 == indir1) && (index3 == index1)
            && (indir2 == EIndirection.CONSTANT) && (index2 == 0xffffffff))
        || //
        ((indir2 == indir1) && (index2 == index1)
            && (indir3 == EIndirection.CONSTANT) && (index3 == 0xffffffff)) || //
    ((indir3 == indir1) && (index3 == index1) && (indir1 == indir2) && (index1 == index2)));
  }
