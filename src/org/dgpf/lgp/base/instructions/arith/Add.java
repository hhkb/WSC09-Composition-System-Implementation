 ...
 * Original Filename: org.dgpf.machine.ll.instructions.arith.Add.java
...
/**
 * This instruction adds two numbers.
 * 
 * @author Thomas Weise
 */
public class Add extends ArithInstruction {
   ...
   */
  public Add(final InstructionSet isb) {
    super(isb);
  }
  ...
  protected boolean isUseless(final EIndirection indir1, final int index1,
    ...
    return (super
        ...
        ((indir3 == indir1) && (index3 == index1)
            && (indir2 == EIndirection.CONSTANT) && (index2 == 0)) || ((indir2 == indir1)
        && (index2 == index1) && (indir3 == EIndirection.CONSTANT) && (index3 == 0)));
  }
