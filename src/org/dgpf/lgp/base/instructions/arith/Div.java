 ...
 * Original Filename: org.dgpf.machine.ll.instructions.arith.Div.java
...
/**
 * This instruction divides two numbers.
 * 
 * @author Thomas Weise
 */
public class Div extends ArithInstruction {
   ...
   * the operation text
   */
  static final char[] OP_TXT = " / ".toCharArray(); //$NON-NLS-1$
   ...
   */
  public Div(final InstructionSet isb) {
    super(isb);
  }
  ...
  protected boolean isUseless(final EIndirection indir1, final int index1,
    ...
    ((indir3 == EIndirection.CONSTANT) && ((index3 == 0) || ((indir2 == indir1)
        && (index2 == index1) && (index3 == 1)))));
  }
