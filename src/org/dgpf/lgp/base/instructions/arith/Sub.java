 ...
 * Original Filename: org.dgpf.machine.ll.instructions.arith.Sub.java
...
/**
 * This instruction subtracts two numbers.
 * 
 * @author Thomas Weise
 */
public class Sub extends ArithInstruction {
   ...
   */
  public Sub(final InstructionSet isb) {
    super(isb);
  }
  ...
  protected boolean isUseless(final EIndirection indir1, final int index1,
    ...
    return (super
        ...
        || //
        ((index3 == index1) && (indir3 == indir1)
            && (indir2 == EIndirection.CONSTANT) && (index2 == 0)) || ((index2 == index1)
        && (indir2 == indir1) && (indir3 == EIndirection.CONSTANT) && (index3 == 0)));
  }
