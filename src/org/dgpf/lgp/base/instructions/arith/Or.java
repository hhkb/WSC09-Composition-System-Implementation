 ...
 * Original Filename: org.dgpf.machine.ll.instructions.arith.Or.java
...
/**
 * This instruction ors two numbers.
 * 
 * @author Thomas Weise
 */
public class Or extends ArithInstruction {
   ...
   * the operation text
   */
  static final char[] OP_TXT = " or ".toCharArray(); //$NON-NLS-1$
   ...
   */
  public Or(final InstructionSet isb) {
    super(isb);
  }
  ...
  protected boolean isUseless(final EIndirection indir1, final int index1,
    ...
    return (super
        ...
        ((indir3 == indir1) && (index3 == index1)
            && (indir2 == EIndirection.CONSTANT) && (index2 == 0)) || //
        ((indir2 == indir1) && (index2 == index1)
            && (indir3 == EIndirection.CONSTANT) && (index3 == 0)) || //
    ((indir1 == indir2) && (index1 == index2) && (indir3 == indir1) && (index1 == index3)));
  }
