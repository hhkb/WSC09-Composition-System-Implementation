 ...
 * Original Filename: org.dgpf.symbolicRegression.scalar.real.Cos.java
 ...
 * @author Thomas Weise
 */
public class Cos extends RealExpression {
  /**
   ...
   * the and factory
   */
  public static final NodeFactory COS_FACTORY = new RealFactory(Cos.class,
      1) {
    /**
     * the serial version uid
     */
   ...
   *          the child nodes
   */
  public Cos(final Node[] children) {
    super(children);
  }
  ...
  public double compute(final double x, final ComputationContext<?> c) {
    ...
    return this.doUnaryCheck(a, Math.cos(a), c);
  }
