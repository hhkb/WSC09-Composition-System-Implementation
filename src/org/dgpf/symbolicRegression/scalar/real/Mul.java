 ...
 * Original Filename: org.dgpf.symbolicRegression.scalar.real.Mul.java
 ...
 * @author Thomas Weise
 */
public class Mul extends RealExpression {
  /**
   ...
   * the and factory
   */
  public static final NodeFactory MUL_FACTORY = new RealFactory(Mul.class,
      2) {
    /**
     * the serial version uid
     */
   ...
   *          the child nodes
   */
  public Mul(final Node[] children) {
    super(children);
  }
  ...
  public double compute(final double x, final ComputationContext<?> c) {
    ...
    return this.doBinaryCheck(a, b, a * b, c);
  }
