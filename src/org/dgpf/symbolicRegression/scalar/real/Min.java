 ...
 * Original Filename: org.dgpf.symbolicRegression.scalar.real.Min.java
 ...
 * @author Thomas Weise
 */
public class Min extends RealExpression {
  /**
   ...
   * the and factory
   */
  public static final NodeFactory MIN_FACTORY = new RealFactory(Min.class,
      2) {
    /**
     * the serial version uid
     */
   ...
   *          the child nodes
   */
  public Min(final Node[] children) {
    super(children);
  }
