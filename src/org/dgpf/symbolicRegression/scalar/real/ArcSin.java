 ...
 * Original Filename: org.dgpf.symbolicRegression.scalar.real.ArcSin.java
...
/**
 * the arc sin operation
 * 
 * @author Thomas Weise
 */
public class ArcSin extends RealExpression {
  /**
   ...
   * the and factory
   */
  public static final NodeFactory ARCSIN_FACTORY = new RealFactory(ArcSin.class,
      1) {
    /**
     * the serial version uid
     */
   ...
   *          the child nodes
   */
  public ArcSin(final Node[] children) {
    super(children);
  }
  ...
  public double compute(final double x, final ComputationContext<?> c) {
    ...
    return this.doUnaryCheck(a, Math.asin(a), c);
  }
