 ...
 * Original Filename: org.dgpf.symbolicRegression.scalar.real.Abs.java
 ...
 * @author Thomas Weise
 */
public class Abs extends RealExpression {
  /**
   ...
   * the abs factory
   */
  public static final NodeFactory ABS_FACTORY = new RealFactory(Abs.class,
      1) {
    /**
     * the serial version uid
     */
   ...
   *          the child nodes
   */
  public Abs(final Node[] children) {
    super(children);
  }
  ...
  public double compute(final double x, final ComputationContext<?> c) {
    ...
    return this.doUnaryCheck(a, Math.abs(a), c);
  }
