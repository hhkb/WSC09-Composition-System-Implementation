 ...
 * Original Filename: org.dgpf.symbolicRegression.scalar.real.ArcCos.java
...
/**
 * the arc cos operation
 * 
 * @author Thomas Weise
 */
public class ArcCos extends RealExpression {
  /**
   ...
   * the and factory
   */
  public static final NodeFactory ARCCOS_FACTORY = new RealFactory(
      ArcCos.class, 1) {
    /**
     * the serial version uid
     */
   ...
   *          the child nodes
   */
  public ArcCos(final Node[] children) {
    super(children);
  }
  ...
  public double compute(final double x, final ComputationContext<?> c) {
    ...
    return this.doUnaryCheck(a, Math.acos(a), c);
  }
