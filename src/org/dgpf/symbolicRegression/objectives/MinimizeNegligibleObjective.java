 ...
 * Original Filename: org.dgpf.symbolicRegression.objectives.NoNegligible.java
 ...
 * @author Thomas Weise
 */
public class MinimizeNegligibleObjective extends
  ...
  ComputationContext<Node>> MINIMIZE_NEGLIGIBLE_OBJECTIVE = new MinimizeNegligibleObjective();

  /**
   * Create the objective function
   */
  protected MinimizeNegligibleObjective() {
    super();
  }
  ...
  private final Object readResolve() {
    if (this.getClass() == MinimizeNegligibleObjective.class)
      return MINIMIZE_NEGLIGIBLE_OBJECTIVE;
    return this;
  }
  ...
  public void toStringBuilder(final StringBuilder sb) {
    sb.append("negligible"); //$NON-NLS-1$
  }
