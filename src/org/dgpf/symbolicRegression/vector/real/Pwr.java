 ...
 * Original Filename: org.dgpf.symbolicRegression.vector.real.Pwr.java
 ...
 * @author Thomas Weise
 */
public class Pwr extends RealExpression {
  /**
   ...
   * the and factory
   */
  public static final NodeFactory PWR_FACTORY = new RealFactory(Pwr.class,
      2) {
    /**
     * the serial version uid
     */
   ...
   *          the child nodes
   */
  public Pwr(final Node[] children) {
    super(children);
  }
  ...
  public double compute(final double[] x, final ComputationContext<?> c) {
    ...
    return this.doBinaryCheck(a, b, Math.pow(a, b), c);
  }
