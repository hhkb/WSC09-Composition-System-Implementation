 ...
 * Original Filename: org.dgpf.symbolicRegression.vector.real.Add.java
 ...
 * @author Thomas Weise
 */
public class Add extends RealExpression {
  /**
   ...
   * the and factory
   */
  public static final NodeFactory ADD_FACTORY = new RealFactory(Add.class,
      2) {
    /**
     * the serial version uid
     */
   ...
   *          the child nodes
   */
  public Add(final Node[] children) {
    super(children);
  }
