 ...
 * Original Filename: org.dgpf.symbolicRegression.vector.real.Div.java
 ...
 * @author Thomas Weise
 */
public class Div extends RealExpression {
  /**
   ...
   * the and factory
   */
  public static final NodeFactory DIV_FACTORY = new RealFactory(Div.class,
      2) {
    /**
     * the serial version uid
     */
   ...
   *          the child nodes
   */
  public Div(final Node[] children) {
    super(children);
  }
