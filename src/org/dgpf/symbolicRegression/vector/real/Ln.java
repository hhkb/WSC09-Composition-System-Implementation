 ...
 * Original Filename: org.dgpf.symbolicRegression.vector.real.Ln.java
 ...
 * @author Thomas Weise
 */
public class Ln extends RealExpression {
  /**
   ...
   * the and factory
   */
  public static final NodeFactory LN_FACTORY = new RealFactory(Ln.class, 1) {
    /**
     * the serial version uid
     */
    private static final long serialVersionUID = 1;
  ...
  public double compute(final double[] x, final ComputationContext<?> c) {
    ...
    return this.doUnaryCheck(a, Math.log(a), c);
  }
