 ...
 * Original Filename: org.dgpf.symbolicRegression.vector.real.Sin.java
 ...
 * @author Thomas Weise
 */
public class Sin extends RealExpression {
  /**
   ...
   * the and factory
   */
  public static final NodeFactory SIN_FACTORY = new RealFactory(Sin.class,
      1) {
    /**
     * the serial version uid
     */
   ...
   *          the child nodes
   */
  public Sin(final Node[] children) {
    super(children);
  }
  ...
  public double compute(final double[] x, final ComputationContext<?> c) {
    ...
    return this.doUnaryCheck(a, Math.sin(a), c);
  }
