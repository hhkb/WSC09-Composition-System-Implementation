...
/**
 * The factory for clause
 * 
 * @author Thomas Weise
 */
public class ClauseFactory extends NodeFactory {
  /**
...
/**
 * the globally shared instance of the clause factory
 */
  public static final ClauseFactory CLAUSE_FACTORY = new ClauseFactory();
  
  /**
   * Create a new node factory.
   */
  protected ClauseFactory() {
    super(Clause.class, 1, 10);
  }
