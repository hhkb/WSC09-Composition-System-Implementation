 ...
 * Original Filename: org.dgpf.fraglets.base.instructions.Variable.java
...
/**
 * The marker instruction simple defines a marker inside the fraglet
 * 
 * @author Thomas Weise
 */
public class Marker extends
   ...
   *          the instruction set
   */
  public Marker(final InstructionSet is) {
    super(is);
  }
