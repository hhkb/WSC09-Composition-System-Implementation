 ...
 * @author Thomas Weise
 */
public class SetAction extends
   ...
   *          the child nodes
   */
  public SetAction(final Node[] children, final Symbol symbol) {
    super(children);
  ...
  public static final void initSymbols(final SymbolSet symbols) {
    ...
    for (i = (symbols.size() - 1); i >= 0; i--) {
      if (!(symbols.get(i).m_writeProtected))
        c++;
    }
  ...
  public boolean equals(final Object o) {
    if (!(super.equals(o)))
      return false;
    return ((SetAction) o).m_symbol.equals(this.m_symbol);
  }
}
