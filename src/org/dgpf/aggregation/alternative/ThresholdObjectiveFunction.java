 ...
 * Original Filename: org.dgpf.aggregation.simulation.ThresholdObjectiveFunction.java
 ...
 * produce lower threshold values.
 * 
 * @author Thomas Weise
 */
public class ThresholdObjectiveFunction extends
   ...
   *          the parameters
   */
  public ThresholdObjectiveFunction(final CalculationParameters params,
  ...
  public void endEvaluation(final AggregationNetProgram individual,
    ...
    state.setObjectiveValue(Math.abs(simulation.m_above
        - simulation.m_below));
  }
