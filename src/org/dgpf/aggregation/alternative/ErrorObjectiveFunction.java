 ...
 * Original Filename: org.dgpf.aggregation.simulation.ErrorObjectiveFunction.java
 ...
 * @author Thomas Weise
 */
public class ErrorObjectiveFunction extends AggregationObjectiveFunction {
  /**
   ...
   *          the parameters
   */
  public ErrorObjectiveFunction(final CalculationParameters params,
  ...
  public void endEvaluation(final AggregationNetProgram individual,
    ...
    if (simulation.m_cs >= Mathematics.ld(simulation.getVMCount())) {
      d = Calculation.applyWeight(simulation.m_error, individual
          .getWeight());
