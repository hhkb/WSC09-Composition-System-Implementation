 ...
 * Original Filename: org.dgpf.aggregation.base.constructs.PartFactory.java
 ...
 * @author Thomas Weise
 */
public class PartFactory extends NodeFactory {
  /** the serial version uid */
  private static final long serialVersionUID = 1;

  /**
   * The globally shared default part factory
   */
  public static final INodeFactory PART_FACTORY = new PartFactory(
      Part.class);
   ...
   *          the node clazz
   */
  protected PartFactory(final Class<? extends Part> clazz) {
    super(clazz, 0, Integer.MAX_VALUE);
  }
  ...
  public boolean isChildAllowed(final Class<? extends Node> clazz,
    ...
    // Program.canBeArbitrarilyNested(clazz);
  }
