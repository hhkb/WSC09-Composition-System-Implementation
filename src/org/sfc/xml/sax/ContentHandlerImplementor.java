 ...
 * Original Filename: org.sfc.xml.sax.ContentHandlerImplementor.java
 ...
 * @author Thomas Weise
 */
public class ContentHandlerImplementor implements ContentHandler {

  /**
   * Create a new <code>ContentHandlerImplementor</code>. This
   * constructor ensures that <code>ContentHandlerImplementor</code>s
   * will only be created from subclasses and not by hand.
   */
  protected ContentHandlerImplementor() {
    super();
  }
