 ...
 * Original Filename: org.sfc.io.ReferenceCountedInputStream.java
 ...
 * @author Thomas Weise
 */
public abstract class ReferenceCountedInputStream extends InputStream
   ...
   */
  protected ReferenceCountedInputStream() {
    super();
    this.m_refCount = 1;
    this.m_living = true;
  }
