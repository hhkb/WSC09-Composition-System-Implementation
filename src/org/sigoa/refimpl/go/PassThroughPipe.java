 ...
 * Original Filename: org.sigoa.refimpl.go.PassThroughPipe.java
 ...
 * pass through individuals based on a pipe strategy.
 *
 * @param <G>
 *          The genotype.
 * @param <PP>
 ...
 * @author Thomas Weise
 */
public class PassThroughPipe<G extends Serializable, PP extends Serializable>
    extends Pipe<G, PP> implements IPassThroughParameters {
  /**
   ...
   */
  protected PassThroughPipe(final int count) {
    super();
    if (count <= 0)
