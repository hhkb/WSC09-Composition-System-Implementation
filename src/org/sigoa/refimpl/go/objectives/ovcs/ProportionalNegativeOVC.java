 ...
 * @author Thomas Weise
 */
public class ProportionalNegativeOVC extends
   ...
   */
  public static final IObjectiveValueComputer PROPORTIONAL_NEGATIVE_OVC = new ProportionalNegativeOVC();

  /**
   * the hidden constructor
   */
  protected ProportionalNegativeOVC() {
    super();
  }
  ...
  private final Object readResolve() {
    return PROPORTIONAL_NEGATIVE_OVC;
  }
